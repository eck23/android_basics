...
import com.example.loginscreen.api.values.page
...
class HomeFragmentViewModel : ViewModel() {
    ...
    private val carImages: IntArray =
        intArrayOf(R.drawable.car_blue, R.drawable.car_red, R.drawable.car_green)

    fun getCarData(isByPages: Boolean = false) {
        ...
        viewModelScope.launch {
            ...
            try {
                page += 1
                val carData =
                    if (isByPages) service.getCarNamesByPage(page) else service.getCarNames()
